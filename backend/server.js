...
port: Define el puerto en el que el servidor escuchará las peticiones. En este caso, es el puerto 4000*/
...
/**app.use(express.json()): Configura el servidor para que pueda interpretar las solicitudes con cuerpo en formato JSON.
app.use(cors()): Habilita el manejo de CORS para permitir solicitudes desde diferentes dominios. */

// db connection

connectDB();

/**Llama a la función connectDB, que probablemente se encarga de establecer una conexión con la base de datos (probablemente MongoDB, dado el contexto). */
